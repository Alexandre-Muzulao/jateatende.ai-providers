...
const links = [
  ...
  { name: 'Meu Perfil', href: '/dashboard/perfil', icon: AdjustmentsHorizontalIcon, Tooltip: 'Seus dados' },
  { name: 'Serviços', href: '/dashboard/portifolios', icon: WrenchScrewdriverIcon, Tooltip: 'Todos os serviços' },
  { name: 'Atendimentos', href: '/dashboard/services', icon: WrenchIcon, Tooltip: 'Registro dos atendimentos' },
